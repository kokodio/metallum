...
public final class MetalTerrainFaceCulling {
	...
	public static void setCameraPosition(final @Nullable Vec3 cameraPosition) {
	...
	public static void registerVisibleRanges(
		...
		int baseVertex = Math.toIntExact(slice.vertexBufferOffset() / MetalTerrainVertexPacking.PACKED_TERRAIN_VERTEX_SIZE);
